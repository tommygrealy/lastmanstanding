...
<html>
    <head>
        ...
        <script src="<?php echo $myServerConfig->http_proto //code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.min.js"></script>
    ...
    <body>
        <div data-role="page">
            ...
            <div data-role="content">
                <form data-ajax="false" action="edit_account.php" method="post"> 
                    Username:<br /> 
