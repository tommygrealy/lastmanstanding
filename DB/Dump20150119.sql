...
-- Generation Time: Jan 19, 2015 at 11:03 AM
...
-- Procedures
--
CREATE DEFINER=`lmstest`@`%` PROCEDURE `checkResultsVsPredictions`()
BEGIN
...
CREATE DEFINER=`lmstest`@`%` PROCEDURE `insertPrediction`(
IN 
inFixtureID int(11),
...
CREATE DEFINER=`lmstest`@`%` PROCEDURE `selectRandomTeam`(IN `inUser` VARCHAR(255))
    NO SQL
...
CREATE DEFINER=`lmstest`@`%` PROCEDURE `showAvailableTeamsForUser`(inUserName varchar(255))
BEGIN
...
CREATE DEFINER=`lmstest`@`%` PROCEDURE `showCurrentStandings`()
BEGIN
select username, FullName, CompStatus from users where PaymentStatus='Paid';

END$$

CREATE DEFINER=`lmstest`@`%` PROCEDURE `showPredsByGameWeek`(IN `inGameWeek` INT)
    NO SQL
select * from predictions where gameweek=inGameWeek$$

CREATE DEFINER=`lmstest`@`%` PROCEDURE `showUserCurrentSelection`(inUserName varchar(255))
BEGIN
...
CREATE DEFINER=`lmstest`@`%` PROCEDURE `showUserPredictionHistory`(IN inUsername varchar(255))
BEGIN
...
CREATE DEFINER=`lmstest`@`%` PROCEDURE `updatePaymentStatus`(
IN 
inUserName varchar(255),
...
(237, '2015-01-19 20:00:00', 'Everton', 'West Bromwich Albion', NULL, NULL, NULL),
...
(245, '2015-02-01 13:30:00', 'Arsenal', 'Aston Villa', NULL, NULL, NULL),
(246, '2015-01-31 17:30:00', 'Chelsea', 'Manchester City', NULL, NULL, NULL),
(247, '2015-01-31 15:00:00', 'Crystal Palace', 'Everton', NULL, NULL, NULL),
(248, '2015-01-31 12:45:00', 'Hull City', 'Newcastle United', NULL, NULL, NULL),
...
(251, '2015-02-01 16:00:00', 'Southampton', 'Swansea City', NULL, NULL, NULL),
...
(257, '2015-02-07 17:30:00', 'Everton', 'Liverpool', NULL, NULL, NULL),
...
(263, '2015-02-07 12:45:00', 'Tottenham Hotspur', 'Arsenal', NULL, NULL, NULL),
...
INSERT INTO `predictions` (`DateTimeEntered`, `EntryType`, `PredictionID`, `GameWeek`, `FixtureID`, `UserName`, `TeamName`, `PredictedResult`, `PredictionCorrect`) VALUES
('2015-01-12 11:06:58', '', 246, 22, 243, 'tommygrealy', 'Tottenham Hotspur', 1, NULL),
('2015-01-12 11:41:55', '', 247, 22, 243, 'JohnLynch1982', 'Tottenham Hotspur', 1, NULL),
('2015-01-14 10:28:17', '', 248, 22, 243, 'tonydoyle', 'Tottenham Hotspur', 1, NULL),
('2015-01-14 10:28:32', '', 249, 22, 244, 'monkey', 'West Ham United', 1, NULL),
('2015-01-14 10:39:50', '', 250, 22, 244, 'kmacken', 'West Ham United', 1, NULL),
('2015-01-14 11:23:48', '', 251, 22, 244, 'Rodge', 'West Ham United', 1, NULL),
('2015-01-14 11:45:02', '', 252, 22, 244, 'declancotter', 'West Ham United', 1, NULL),
('2015-01-14 15:59:53', '', 253, 22, 236, 'mjnolan', 'Burnley', 1, NULL),
('2015-01-15 09:10:11', '', 254, 22, 244, 'jbligh', 'West Ham United', 1, NULL),
('2015-01-15 11:06:11', '', 255, 22, 240, 'Gforde', 'Southampton', 3, NULL),
('2015-01-16 14:04:43', '', 256, 22, 236, 'telordan', 'Burnley', 1, NULL),
('2015-01-16 21:52:40', '', 257, 22, 242, 'shethert', 'Swansea City', 1, NULL),
('2015-01-17 10:22:57', '', 258, 22, 237, 'jamesoneill', 'Everton', 1, NULL);
...
--
-- Stand-in structure for view `ThisWeeksPredictions`
--
CREATE TABLE IF NOT EXISTS `ThisWeeksPredictions` (
`FullName` varchar(45)
,`HomeTeam` varchar(50)
,`AwayTeam` varchar(50)
...
(2041, 'tommygrealy', 'Tommy Grealy', '9bee4021cb6373bbb36ef9fc0a0de96a1da025024a49d00cbcb7f3a5d6927c13', '12c35acf6fde1c66', 'tommygrealy@gmail.com', 'Playing', 'Paid'),
(2042, 'jamesoneill', 'James O''Neill', '27bb94c49c5361c3525af95026f5337b748c3cec02ccf88be780e86d3ba8e8d8', '44ee29c07d65a476', 'james.a.o''neill@intel.com', 'Playing', 'Paid'),
(2043, 'declancotter', 'Declan Cotter', '1875f1ff59cfef14d63c322bbcff0616a446c71e22877316f0fd1b076edff095', '40edec6e6dd62bc4', 'declan.cotter@intel.com', 'Playing', 'Paid'),
(2044, 'mjnolan', 'mike nolan', '3fc8f3fbbabd0a9cc423af665b06cad5ce2f9dce31b3e2cff63458ba1cef8e7c', '6004b6498122843', 'michael.nolan@intel.com', 'Playing', 'Paid'),
(2045, 'JohnLynch1982', 'John Lynch', '54658097a78a65db548da9b3122ecff22e8dbeec48d7dc423c5d606deaf50870', 'ce64ca04950dfb7', 'johnlynch1982@gmail.com', 'Playing', 'Paid'),
(2046, 'monkey', 'Pat Guerin', '553444ca74412f66853b074035fb8b0dda447ddab2f3764d255f59fe48ee831c', '698dd37229928f09', 'patrick.guerin@intel.com', 'Playing', 'Paid'),
(2047, 'tonydoyle', 'Tony Doyle', '95e3783bbe397b91b2c314ca06a1edcc854d4de79380d6d2c1e51558b20a8578', '378b8db242f1183f', 'anthonyx.doyle@intel.com', 'Playing', 'Paid'),
(2048, 'kmacken', 'Kieran Macken', '1743e9472114cac5716f7f5c50dbd871210cd008fc6ba48c17008bbfb8030aec', 'fcfd1154d4cea0d', 'kieran.j.macken@gmail.com', 'Playing', 'Paid'),
(2049, 'Rodge', 'Rodger Mooney', 'b7ba54fa6f50e27cd9946cc88bad693e9652bed3248ed7b878cb0edc3f2c808b', '81e304938d9a4e2', 'rodger.mooney@intel.com', 'Playing', 'Paid'),
(2050, 'jbligh', 'John Bligh', 'bb5b0b36e652088c537ccc7ca4beb77e2fabea73e94ddd32101ea067e87e553e', '2c8deec4158b889c', 'johnbligh@gmail.com', 'Playing', 'Paid'),
(2051, 'Gforde', 'Gerard Forde', 'fc3afe953716a0c5a5c65b5a0f9698981cd6704b0370a03c45dfc8d22b3cd009', '2419bd005367df3a', 'Gerard.m.forde@intel.com', 'Playing', 'Paid'),
(2052, 'telordan', 'Thomas', '45867e58ab21df185ccd7e5ba852ccabbd981284de57b0987e1b57e684298278', '5c154aa5712ecfa3', 'thomas.e.lordan@intel.com', 'Playing', 'Paid'),
(2053, 'shethert', 'Seamus Hetherton', '224426ad6e0405b8c3209db29bba0e839625d8cd91507030209806c95f0b0c0a', '61c2e6a43c941072', 'seamus.p.hetherton@intel.com', 'Playing', 'Paid');
...
--
-- Structure for view `ThisWeeksPredictions`
--
DROP TABLE IF EXISTS `ThisWeeksPredictions`;

CREATE ALGORITHM=UNDEFINED DEFINER=`lmstest`@`%` SQL SECURITY DEFINER VIEW `ThisWeeksPredictions` AS select `users`.`FullName` AS `FullName`,`fixtureresults`.`HomeTeam` AS `HomeTeam`,`fixtureresults`.`AwayTeam` AS `AwayTeam`,`predictions`.`TeamName` AS `User Selected`,`predictions`.`DateTimeEntered` AS `DateTimeEntered` from ((`users` join `predictions` on((`users`.`username` = `predictions`.`UserName`))) join `fixtureresults` on((`predictions`.`FixtureID` = `fixtureresults`.`FixtureId`)));
